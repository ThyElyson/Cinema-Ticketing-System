...
void show_posters()
{
	...
	{
		cout << "____________________________________" << "    " << "____________________________________" << "  " << "____________________________________" << endl;
		cout << "|           +%%-              -+###+" << "    " << "|                                  |" << "  " << "|   *@@@@@@@@@@@@@@@@@@@@@@@@*:    |" << endl;
		cout << "|    #--  +%#%%#%%*--   x--+########" << "    " << "|   *+:                            |" << "  " << "|  .:@@@@@@@@@@@@@@@@@@@@@@@@#     |" << endl;
		cout << "|    *@@%@@@%*==#@@%%#############-|" << "    " << "| -#@%-                     +##.   |" << "  " << "|     .:::#@@@@@@@@@@@@@@@@@@%@#   |" << endl;
		cout << "|   #@@@@%@@@@@@@@@@%%%%########+  |" << "    " << "|     :@@=   %*-           @@@@@   |" << "  " << "|           .%-  :* :@@@@@@:       |" << endl;
	...
	{
		cout << "_____________________________________" << "   " << "_____________________________________" << "   " << "_____________________________________" << endl;
		cout << "|        @-.   *=::::::::-%=@@@@    |" << "   " << "|    ..==..:=:. .+:    .==*-#.      |" << "   " << "|           ..+#%%%%%#-.            |" << endl;
		cout << "|        @:...%::::::::::::%:  =@   |" << "   " << "|        .+:...=+=+. .=----=.       |" << "   " << "|          .:#%%%%%%%%%*.           |" << endl;
		cout << "|         @+.=-::::%:::%-:::*..*@   |" << "   " << "|          .-=:....-+----==.        |" << "   " << "|          .*%%%%%%%%%%%-.          |" << endl;
		cout << "|        %. .%::::::::::::::++++%@  |" << "   " << "|             .=..==----+.          |" << "   " << "|          .#%##%%%%###%+.          |" << endl;
	...
	{
		cout << "____________________________________" << "   " << "____________________________________" << "   " << "___________________________________" << endl;
		cout << "|   @*@@@@@-::@@@@@@@*:::::::::::::|" << "   " << "|@@@%*--=+-:-#@@@@@@@@@%*--=+-:-#@@|" << "   " << "|@@@@@@@+..:+@@@@@@@@@@@%%...%@@@@|" << endl;
		cout << "|   @*@@@@@+::#@@@@@@@@@::::::::::=|" << "   " << "|@@@%*--=+-:-#@@@@@@@@@%*--=+-:-#@@|" << "   " << "|@@@@@@@@%....@@@@@@@@@%...=%@@@@@|" << endl;
		cout << "|   @+@@@@=::::%@@@@@@@@%:::::::::%|" << "   " << "|@@@%*--=+-:-#@@@@@@@@@%*--=+-:-#@@|" << "   " << "|@@@@@@@@@@@#%#%@@@@@@%+%%%@@@@@@@|" << endl;
		cout << "|   @#::::*@@-::*@@@@@@@:::::::::*@|" << "   " << "|@@@%*--=+-:-#@@@@@@@@@%*--=+-:-#@@|" << "   " << "|@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@|" << endl;
